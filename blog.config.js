...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'beijihu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个行走在仙界的凡人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.onino.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yinjun@jshuaxin.net', // 邮箱地址 例如mail@tangly1024.com
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '这里是怪兽的家，一定什么都有...', // 站点描述，被notion中的页面描述覆盖
